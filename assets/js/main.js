...
(function () {
  ...
  /* ---------- 表单提交至 Formspark 后端 ---------- */
  var FORMSPARK_ENDPOINT = 'https://submit-form.com/YHLIrNSOG';
  ...
  function bindIntake(formId) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch(FORMSPARK_ENDPOINT, {
        ...
        showError(form, '提交未能送达（可能被反垃圾邮件拦截或网络异常）。您填写的内容已保留，请稍后重试，或直接通过页面下方联系方式与我们沟通。');
      }).finally(function () {
